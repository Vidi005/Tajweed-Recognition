  ...
  <React.Fragment>
      ...
      getFilteredTajweeds={getFilteredTajweeds} />
    {
      location.toString().includes('/detail') 
        ? <Outlet/>
        : (
            <article className="tajweed-desc relative hidden lg:flex flex-col items-center justify-between max-h-full w-3/4 px-16 text-xl bg-green-100 text-green-900 text-justify dark:bg-gray-800 dark:text-white duration-200 overflow-y-auto">
