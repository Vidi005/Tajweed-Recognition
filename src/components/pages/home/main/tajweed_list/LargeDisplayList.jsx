...
const LargeDisplayList = ({ t, searchitem, getFilteredTajweeds }) => {
  ...
  if (findTajweedLaw() === '') {
    <React.Fragment>
      ...
      {/* <article className="no-tajweed-found hidden lg:grid items-center justify-center h-full w-3/4 font-black text-xl bg-green-100 text-green-900 dark:bg-gray-800 dark:text-white">{t('no_tajweed_found')}</article> */}
    </React.Fragment>
  } else {
    return (
      <React.Fragment>
        <SidebarContainer
          ...
          searchitem={searchitem}
          getFilteredTajweeds={getFilteredTajweeds} />
        <article className="detail-tajweed-content hidden lg:inline-block h-full w-3/4 bg-green-100 dark:bg-gray-800 p-2 overflow-y-auto">
