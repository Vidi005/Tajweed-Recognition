...
const extractIdzharCharacters = () => [
  ...
  // ha
  /\u0646(?![\u064B-\u065F]) \u062D/gm, /\u0646\u0652 \u062D/gm, /\u064B \u062D/gm, /\u064C \u062D/gm, /\u064D \u062D/gm, /\u064B (?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u062D/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u062D/gm,
  // Ha
  /\u0646(?![\u064B-\u065F]) \u0647/gm, /\u0646\u0652 \u0647/gm, /\u064B \u0647/gm, /\u064C \u0647/gm, /\u064D \u0647/gm, /\u064B (?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0647/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0647/gm,
  // Kho
  /\u0646(?![\u064B-\u065F]) \u062E/gm, /\u0646\u0652 \u062E/gm, /\u064B \u062E/gm, /\u064C \u062E/gm, /\u064D \u062E/gm, /\u064B (?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u062E/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u062E/gm,
  // 'Ain
  /\u0646(?![\u064B-\u065F]) \u0639/gm, /\u0646\u0652 \u0639/gm, /\u064B \u0639/gm, /\u064C \u0639/gm, /\u064D \u0639/gm, /\u064B (?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0639/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0639/gm,
  // Gho
  /\u0646(?![\u064B-\u065F]) \u063A/gm, /\u0646\u0652 \u063A/gm, /\u064B \u063A/gm, /\u064C \u063A/gm, /\u064D \u063A/gm, /\u064B (?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u063A/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u063A/gm,
  // Alif
  /\u0646(?![\u064B-\u065F])\u0627(?:[\u064B-\u065F])/gm, /\u0646\u0652\u0627(?:[\u064B-\u065F])/gm, /\u064B\u0627(?:[\u064B-\u065F])/gm, /\u064C\u0627(?:[\u064B-\u065F])/gm, /\u064D\u0627(?:[\u064B-\u065F])/gm, /\u064B\u0627\u0627(?:[\u064B-\u065F])/gm,
  // ha
  /\u0646(?![\u064B-\u065F])\u062D/gm, /\u0646\u0652\u062D/gm, /\u064B\u062D/gm, /\u064C\u062D/gm, /\u064D\u062D/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649])\u062D/gm,
  // Ha
  /\u0646(?![\u064B-\u065F])\u0647/gm, /\u0646\u0652\u0647/gm, /\u064B\u0647/gm, /\u064C\u0647/gm, /\u064D\u0647/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649])\u0647/gm,
  // Kho
  /\u0646(?![\u064B-\u065F])\u062E/gm, /\u0646\u0652\u062E/gm, /\u064B\u062E/gm, /\u064C\u062E/gm, /\u064D\u062E/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649])\u062E/gm,
  // 'Ain
  /\u0646(?![\u064B-\u065F])\u0639/gm, /\u0646\u0652\u0639/gm, /\u064B\u0639/gm, /\u064C\u0639/gm, /\u064D\u0639/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649])\u0639/gm,
  // Gho
  /\u0646(?![\u064B-\u065F])\u063A/gm, /\u0646\u0652\u063A/gm, /\u064B\u063A/gm, /\u064C\u063A/gm, /\u064D\u063A/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649])\u063A/gm
]

const extractIdghamBigunnahCharacters = () => [
  // Ya
  /\u0646(?![\u064B-\u065F]) \u064A/gm, /\u0646\u0652 \u064A/gm, /\u064B \u064A/gm, /\u064C \u064A/gm, /\u064D \u064A/gm, /\u064B (?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u064A/gm,
  // Nun
  /\u0646(?![\u064B-\u065F]) \u0646/gm, /\u0646\u0652 \u0646/gm, /\u064B \u0646/gm, /\u064C \u0646/gm, /\u064D \u0646/gm, /\u064B (?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0646/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0646/gm,
  // Mim
  /\u0646(?![\u064B-\u065F]) \u0645/gm, /\u0646\u0652 \u0645/gm, /\u064B \u0645/gm, /\u064C \u0645/gm, /\u064D \u0645/gm, /\u064B (?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0645/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0645/gm,
  // Wau
  /\u0646(?![\u064B-\u065F]) \u0648/gm, /\u0646\u0652 \u0648/gm, /\u064B \u0648/gm, /\u064C \u0648/gm, /\u064D \u0648/gm, /\u064B (?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0648/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0648/gm,
  // Ya
  /\u0646(?![\u064B-\u065F])\u064A/gm, /\u0646\u0652\u064A/gm, /\u064B\u064A/gm, /\u064C\u064A/gm, /\u064D\u064A/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649])\u064A/gm,
  // Nun
  /\u0646(?![\u064B-\u065F])\u0646/gm, /\u0646\u0652\u0646/gm, /\u064B\u0646/gm, /\u064C\u0646/gm, /\u064D\u0646/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649])\u0646/gm,
  // Mim
  /\u0646(?![\u064B-\u065F])\u0645/gm, /\u0646\u0652\u0645/gm, /\u064B\u0645/gm, /\u064C\u0645/gm, /\u064D\u0645/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649])\u0645/gm,
  // Wau
  /\u0646(?![\u064B-\u065F])\u0648/gm, /\u0646\u0652\u0648/gm, /\u064B\u0648/gm, /\u064C\u0648/gm, /\u064D\u0648/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649])\u0648/gm
]

const extractIdghamBilagunnahCharacters = () => [
  // Lam
  /\u0646(?![\u064B-\u065F]) \u0644/gm, /\u0646\u0652 \u0644/gm, /\u064B \u0644/gm, /\u064C \u0644/gm, /\u064D \u0644/gm, /\u064B (?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0644/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0644/gm,
  // Rho
  /\u0646(?![\u064B-\u065F]) \u0631/gm, /\u0646\u0652 \u0631/gm, /\u064B \u0631/gm, /\u064C \u0631/gm, /\u064D \u0631/gm, /\u064B (?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0631/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0631/gm,
  // Lam
  /\u0646(?![\u064B-\u065F])\u0644/gm, /\u0646\u0652\u0644/gm, /\u064B\u0644/gm, /\u064C\u0644/gm, /\u064D\u0644/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649])\u0644/gm,
  // Rho
  /\u0646(?![\u064B-\u065F])\u0631/gm, /\u0646\u0652\u0631/gm, /\u064B\u0631/gm, /\u064C\u0631/gm, /\u064D\u0631/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649])\u0631/gm
]

const extractIqlabCharacters = () => [
  // Ba
  /\u0646(?![\u064B-\u065F]) \u0628/gm, /\u0646\u0652 \u0628/gm, /\u064B \u0628/gm, /\u064C \u0628/gm, /\u064D \u0628/gm, /\u064B (?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0628/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0628/gm,
  /\u0646(?![\u064B-\u065F]) \u0628(?:[\u06E2\u06ED])/gm, /\u0646\u0652 \u0628(?:[\u06E2\u06ED])/gm, /\u064B \u0628(?:[\u06E2\u06ED])/gm, /\u064C \u0628(?:[\u06E2\u06ED])/gm, /\u064D \u0628(?:[\u06E2\u06ED])/gm, /\u064B (?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0628(?:[\u06E2\u06ED])/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0628(?:[\u06E2\u06ED])/gm,
  // Ba
  /\u0646(?![\u064B-\u065F])\u0628/gm, /\u0646\u0652\u0628/gm, /\u064B\u0628/gm, /\u064C\u0628/gm, /\u064D\u0628/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649])\u0628/gm,
  /\u0646(?![\u064B-\u065F])\u0628(?:[\u06E2\u06ED])/gm, /\u0646\u0652\u0628(?:[\u06E2\u06ED])/gm, /\u064B\u0628(?:[\u06E2\u06ED])/gm, /\u064C\u0628(?:[\u06E2\u06ED])/gm, /\u064D\u0628(?:[\u06E2\u06ED])/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649])\u0628(?:[\u06E2\u06ED])/gm
]

const extractIkhfaCharacters = () => [
  // Tha
  /\u0646(?![\u064B-\u065F]) \u0629/gm, /\u0646\u0652 \u0629/gm, /\u064B \u0629/gm, /\u064C \u0629/gm, /\u064D \u0629/gm, /\u064B (?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0629/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0629/gm,
  /\u0646(?![\u064B-\u065F])\u0629/gm, /\u0646\u0652\u0629/gm, /\u064B\u0629/gm, /\u064C\u0629/gm, /\u064D\u0629/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649])\u0629/gm,
  // Ta
  /\u0646(?![\u064B-\u065F]) \u062A/gm, /\u0646\u0652 \u062A/gm, /\u064B \u062A/gm, /\u064C \u062A/gm, /\u064D \u062A/gm, /\u064B (?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u062A/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u062A/gm,
  /\u0646(?![\u064B-\u065F])\u062A/gm, /\u0646\u0652\u062A/gm, /\u064B\u062A/gm, /\u064C\u062A/gm, /\u064D\u062A/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649])\u062A/gm,
  // Tsa
  /\u0646(?![\u064B-\u065F]) \u062B/gm, /\u0646\u0652 \u062B/gm, /\u064B \u062B/gm, /\u064C \u062B/gm, /\u064D \u062B/gm, /\u064B (?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u062B/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u062B/gm,
  /\u0646(?![\u064B-\u065F])\u062B/gm, /\u0646\u0652\u062B/gm, /\u064B\u062B/gm, /\u064C\u062B/gm, /\u064D\u062B/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649])\u062B/gm,
  // Ja
  /\u0646(?![\u064B-\u065F]) \u062C/gm, /\u0646\u0652 \u062C/gm, /\u064B \u062C/gm, /\u064C \u062C/gm, /\u064D \u062C/gm, /\u064B (?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u062C/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u062C/gm,
  /\u0646(?![\u064B-\u065F])\u062C/gm, /\u0646\u0652\u062C/gm, /\u064B\u062C/gm, /\u064C\u062C/gm, /\u064D\u062C/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649])\u062C/gm,
  // Da
  /\u0646(?![\u064B-\u065F]) \u062F/gm, /\u0646\u0652 \u062F/gm, /\u064B \u062F/gm, /\u064C \u062F/gm, /\u064D \u062F/gm, /\u064B (?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u062F/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u062F/gm,
  /\u0646(?![\u064B-\u065F])\u062F/gm, /\u0646\u0652\u062F/gm, /\u064B\u062F/gm, /\u064C\u062F/gm, /\u064D\u062F/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649])\u062F/gm,
  // Dzal
  /\u0646(?![\u064B-\u065F]) \u0630/gm, /\u0646\u0652 \u0630/gm, /\u064B \u0630/gm, /\u064C \u0630/gm, /\u064D \u0630/gm, /\u064B (?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0630/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0630/gm,
  /\u0646(?![\u064B-\u065F])\u0630/gm, /\u0646\u0652\u0630/gm, /\u064B\u0630/gm, /\u064C\u0630/gm, /\u064D\u0630/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649])\u0630/gm,
  // Za
  /\u0646(?![\u064B-\u065F]) \u0632/gm, /\u0646\u0652 \u0632/gm, /\u064B \u0632/gm, /\u064C \u0632/gm, /\u064D \u0632/gm, /\u064B (?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0632/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0632/gm,
  /\u0646(?![\u064B-\u065F])\u0632/gm, /\u0646\u0652\u0632/gm, /\u064B\u0632/gm, /\u064C\u0632/gm, /\u064D\u0632/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649])\u0632/gm,
  // Sa
  /\u0646(?![\u064B-\u065F]) \u0633/gm, /\u0646\u0652 \u0633/gm, /\u064B \u0633/gm, /\u064C \u0633/gm, /\u064D \u0633/gm, /\u064B (?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0633/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0633/gm,
  /\u0646(?![\u064B-\u065F])\u0633/gm, /\u0646\u0652\u0633/gm, /\u064B\u0633/gm, /\u064C\u0633/gm, /\u064D\u0633/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649])\u0633/gm,
  // Syin
  /\u0646(?![\u064B-\u065F]) \u0634/gm, /\u0646\u0652 \u0634/gm, /\u064B \u0634/gm, /\u064C \u0634/gm, /\u064D \u0634/gm, /\u064B (?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0634/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0634/gm,
  /\u0646(?![\u064B-\u065F])\u0634/gm, /\u0646\u0652\u0634/gm, /\u064B\u0634/gm, /\u064C\u0634/gm, /\u064D\u0634/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649])\u0634/gm,
  // Shod
  /\u0646(?![\u064B-\u065F]) \u0635/gm, /\u0646\u0652 \u0635/gm, /\u064B \u0635/gm, /\u064C \u0635/gm, /\u064D \u0635/gm, /\u064B (?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0635/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0635/gm,
  /\u0646(?![\u064B-\u065F])\u0635/gm, /\u0646\u0652\u0635/gm, /\u064B\u0635/gm, /\u064C\u0635/gm, /\u064D\u0635/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649])\u0635/gm,
  // Dhod
  /\u0646(?![\u064B-\u065F]) \u0636/gm, /\u0646\u0652 \u0636/gm, /\u064B \u0636/gm, /\u064C \u0636/gm, /\u064D \u0636/gm, /\u064B (?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0636/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0636/gm,
  /\u0646(?![\u064B-\u065F])\u0636/gm, /\u0646\u0652\u0636/gm, /\u064B\u0636/gm, /\u064C\u0636/gm, /\u064D\u0636/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649])\u0636/gm,
  // Tho
  /\u0646(?![\u064B-\u065F]) \u0637/gm, /\u0646\u0652 \u0637/gm, /\u064B \u0637/gm, /\u064C \u0637/gm, /\u064D \u0637/gm, /\u064B (?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0637/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0637/gm,
  /\u0646(?![\u064B-\u065F])\u0637/gm, /\u0646\u0652\u0637/gm, /\u064B\u0637/gm, /\u064C\u0637/gm, /\u064D\u0637/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649])\u0637/gm,
  // Dzho
  /\u0646(?![\u064B-\u065F]) \u0638/gm, /\u0646\u0652 \u0638/gm, /\u064B \u0638/gm, /\u064C \u0638/gm, /\u064D \u0638/gm, /\u064B (?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0638/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0638/gm,
  /\u0646(?![\u064B-\u065F])\u0638/gm, /\u0646\u0652\u0638/gm, /\u064B\u0638/gm, /\u064C\u0638/gm, /\u064D\u0638/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649])\u0638/gm,
  // Fa
  /\u0646(?![\u064B-\u065F]) \u0641/gm, /\u0646\u0652 \u0641/gm, /\u064B \u0641/gm, /\u064C \u0641/gm, /\u064D \u0641/gm, /\u064B (?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0641/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0641/gm,
  /\u0646(?![\u064B-\u065F])\u0641/gm, /\u0646\u0652\u0641/gm, /\u064B\u0641/gm, /\u064C\u0641/gm, /\u064D\u0641/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649])\u0641/gm,
  // Qaf
  /\u0646(?![\u064B-\u065F]) \u0642/gm, /\u0646\u0652 \u0642/gm, /\u064B \u0642/gm, /\u064C \u0642/gm, /\u064D \u0642/gm, /\u064B (?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0642/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0642/gm,
  /\u0646(?![\u064B-\u065F])\u0642/gm, /\u0646\u0652\u0642/gm, /\u064B\u0642/gm, /\u064C\u0642/gm, /\u064D\u0642/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649])\u0642/gm,
  // Ka
  /\u0646(?![\u064B-\u065F]) \u0643/gm, /\u0646\u0652 \u0643/gm, /\u064B \u0643/gm, /\u064C \u0643/gm, /\u064D \u0643/gm, /\u064B (?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0643/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u0643/gm,
  /\u0646(?![\u064B-\u065F])\u0643/gm, /\u0646\u0652\u0643/gm, /\u064B\u0643/gm, /\u064C\u0643/gm, /\u064D\u0643/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649])\u0643/gm,
  // Kaf
  /\u0646(?![\u064B-\u065F]) \u06A9/gm, /\u0646\u0652 \u06A9/gm, /\u064B \u06A9/gm, /\u064C \u06A9/gm, /\u064D \u06A9/gm, /\u064B (?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u06A9/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649]) \u06A9/gm,
  /\u0646(?![\u064B-\u065F])\u06A9/gm, /\u0646\u0652\u06A9/gm, /\u064B\u06A9/gm, /\u064C\u06A9/gm, /\u064D\u06A9/gm, /\u064B(?:\u0627|\u0627\u0627|[\u0648-\u0649])\u06A9/gm
]
...
const extractMadThabiiCharacters = () => [
  ...
  /\u064E\u0627(?![\u064B-\u065F]|\u0605|\u0653|\u06E4)(?![\u0621-\u0627])/gm, /\u064E \u0627(?![\u0621-\u0627]|\u0605|\u0653|\u06E4|[\u0628-\u0646][\u0651-\u0652]|[\u0628-\u0646][\u064E-\u0650]\u0651) (?![\u0621-\u0627])/gm,
  /\u064E\u0627(?![\u064B-\u065F]|\u0605|\u0653|\u06E4)\u0627(?:[\u064B-\u065F])/gm, /\u064E \u0627(?![\u0621-\u0627]|\u0605|\u0653|\u06E4|[\u0628-\u0646][\u0651-\u0652]|[\u0628-\u0646][\u064E-\u0650]\u0651) \u0627(?:[\u064B-\u065F])/gm,
  // Wau
  ...
  /(?![\u0621-\u0627])\u064F\u0648(?![\u064B-\u065F])(?![\u0621-\u0627]|\u0605|\u0653|\u06E4|[\u0628-\u0646][\u0651-\u0652]|[\u0628-\u0646][\u064E-\u0650]\u0651)/gm, /(?![\u0621-\u0627])\u064F \u0648(?![\u064B-\u065F]) (?![\u0621-\u0627]|\u0605|\u0653|\u06E4|[\u0628-\u0646][\u0651-\u0652]|[\u0628-\u0646][\u064E-\u0650]\u0651)/gm, /(?![\u0621-\u0627])\u064F\u0648(?![\u064B-\u065F])(?![\u0621-\u0627]|\u0605|\u0653|\u06E4|[\u0628-\u0646][\u0651-\u0652]|[\u0628-\u0646][\u064E-\u0650]\u0651)/gm, /(?![\u0621-\u0627])\u064F \u0648(?![\u064B-\u065F]) (?![\u0621-\u0627]|\u0605|\u0653|\u06E4|[\u0628-\u0646][\u0651-\u0652]|[\u0628-\u0646][\u064E-\u0650]\u0651)/gm,
  // Ya
  ...
  /(?![\u0621-\u0627])\u0650\u064A(?![\u064B-\u065F])(?![\u0621-\u0627]|\u0605|\u0653|\u06E4|[\u0628-\u0646][\u0651-\u0652]|[\u0628-\u0646][\u064E-\u0650]\u0651)/gm, /(?![\u0621-\u0627])\u0650 \u064A(?![\u064B-\u065F]) (?![\u0621-\u0627]|\u0605|\u0653|\u06E4|[\u0628-\u0646][\u0651-\u0652]|[\u0628-\u0646][\u064E-\u0650]\u0651)/gm, /(?![\u0621-\u0627])\u0650\u064A(?![\u064B-\u065F])(?![\u0621-\u0627]|\u0605|\u0653|\u06E4|[\u0628-\u0646][\u0651-\u0652]|[\u0628-\u0646][\u064E-\u0650]\u0651)/gm, /(?![\u0621-\u0627])\u0650 \u064A(?![\u064B-\u065F]) (?![\u0621-\u0627]|\u0605|\u0653|\u06E4|[\u0628-\u0646][\u0651-\u0652]|[\u0628-\u0646][\u064E-\u0650]\u0651)/gm,
  // Mad harakah
...
const extractMadAridLissukunCharacters = () => {
  ...
  const madAridLissukun2 = dataCopy.map(regex => new RegExp(regex.source + /(?:[\u0628-\u064A])(?:[\u064B-\u065F]) (?:[\u06D6-\u06DB]|\u06DD[\u0660-\u0669])/gm.source, 'gm'))
  const madAridLissukun2Trimmed = dataCopy.map(regex => new RegExp(regex.source + /(?:[\u0628-\u064A])(?:[\u064B-\u065F])(?:[\u06D6-\u06DB]|\u06DD[\u0660-\u0669])/gm.source, 'gm'))
  return [
    ...madAridLissukun,
