...
const extractMadWajibCharacters = () => {
  ...
  const madWajibDiacriticTrimmed = madThabiiChars.map(regex => new RegExp(regex.source + /(?:\u0605|\u0622|\u0653|\u06E4)\u0621(?:[\u064B-\u065F]|\u0670)/gm.source, 'gm'))
  const madWajibDiacritic = madThabiiChars.map(regex => new RegExp(regex.source + /\s(?:\u0605|\u0622|\u0653|\u06E4) \u0621(?:[\u064B-\u065F]|\u0670)/gm.source, 'gm'))
  const madWajibDiacritic2Trimmed = madThabiiChars.map(regex => new RegExp(regex.source.replace('\u0627', '\u0622') + /\u0621(?:[\u064B-\u065F]|\u0670)/gm.source, 'gm'))
  const madWajibDiacritic2 = madThabiiChars.map(regex => new RegExp(regex.source.replace('\u0627', '\u0622') + /\s\u0621(?:[\u064B-\u065F]|\u0670)/gm.source, 'gm'))
